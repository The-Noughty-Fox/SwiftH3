...
public struct H3Index {
    ...
    */
    ...
    public var geoBoundary: H3GeoBoundary {
        ...
        coordinates.append(.init(lat: degsToRads(boundary.verts.0.lat), lon: degsToRads(boundary.verts.0.lon)))
        coordinates.append(.init(lat: degsToRads(boundary.verts.1.lat), lon: degsToRads(boundary.verts.1.lon)))
        coordinates.append(.init(lat: degsToRads(boundary.verts.2.lat), lon: degsToRads(boundary.verts.2.lon)))
        coordinates.append(.init(lat: degsToRads(boundary.verts.3.lat), lon: degsToRads(boundary.verts.3.lon)))
        coordinates.append(.init(lat: degsToRads(boundary.verts.4.lat), lon: degsToRads(boundary.verts.4.lon)))
        coordinates.append(.init(lat: degsToRads(boundary.verts.5.lat), lon: degsToRads(boundary.verts.5.lon)))
        coordinates.append(.init(lat: degsToRads(boundary.verts.6.lat), lon: degsToRads(boundary.verts.6.lon)))
        coordinates.append(.init(lat: degsToRads(boundary.verts.7.lat), lon: degsToRads(boundary.verts.7.lon)))
        coordinates.append(.init(lat: degsToRads(boundary.verts.8.lat), lon: degsToRads(boundary.verts.8.lon)))
        coordinates.append(.init(lat: degsToRads(boundary.verts.9.lat), lon: degsToRads(boundary.verts.9.lon)))
