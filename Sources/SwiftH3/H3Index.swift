...
public struct H3Index {
    ...
    */
    ...
    public var geoBoundary: H3GeoBoundary {
        ...
        coordinates.append(.init(lat: radsToDegs(boundary.verts.0.lat), lon: radsToDegs(boundary.verts.0.lon)))
        coordinates.append(.init(lat: radsToDegs(boundary.verts.1.lat), lon: radsToDegs(boundary.verts.1.lon)))
        coordinates.append(.init(lat: radsToDegs(boundary.verts.2.lat), lon: radsToDegs(boundary.verts.2.lon)))
        coordinates.append(.init(lat: radsToDegs(boundary.verts.3.lat), lon: radsToDegs(boundary.verts.3.lon)))
        coordinates.append(.init(lat: radsToDegs(boundary.verts.4.lat), lon: radsToDegs(boundary.verts.4.lon)))
        coordinates.append(.init(lat: radsToDegs(boundary.verts.5.lat), lon: radsToDegs(boundary.verts.5.lon)))
        coordinates.append(.init(lat: radsToDegs(boundary.verts.6.lat), lon: radsToDegs(boundary.verts.6.lon)))
        coordinates.append(.init(lat: radsToDegs(boundary.verts.7.lat), lon: radsToDegs(boundary.verts.7.lon)))
        coordinates.append(.init(lat: radsToDegs(boundary.verts.8.lat), lon: radsToDegs(boundary.verts.8.lon)))
        coordinates.append(.init(lat: radsToDegs(boundary.verts.9.lat), lon: radsToDegs(boundary.verts.9.lon)))
